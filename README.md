...
- Define the mass list by straight modification of the mass_values variable (e.g. \[589.95134, 658.87134, 798.78351, 855.55214, 989.15358\])
- Set the tolerance between the theoretical mass and the experimental mass in ppm with the variable "ppm" (e.g. ppm=4 )
- Outputs a file whose name is defined by the variable "output_file", in the same folder, with the corresponding masses and intensities
