...
- Outputs a file whose name is defined by the variable "output_file", in the same folder, with the corresponding masses and intensities (e.g. output_file="output.csv")
